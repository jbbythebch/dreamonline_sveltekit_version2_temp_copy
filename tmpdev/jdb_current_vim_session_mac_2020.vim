...
exe '5resize ' . ((&lines * 20 + 34) / 68)
exe 'vert 5resize ' . ((&columns * 89 + 135) / 270)
argglobal
balt src/routes/_all-locales/user-sign-out/+page.svelte
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists("src/lib/graphql/mutations/user-sign-out.js") | buffer src/lib/graphql/mutations/user-sign-out.js | else | edit src/lib/graphql/mutations/user-sign-out.js | endif
balt src/routes/_all-locales/user-sign-out/+page.svelte
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
argglobal
if bufexists("src/lib/client-utils/get-user-email.js") | buffer src/lib/client-utils/get-user-email.js | else | edit src/lib/client-utils/get-user-email.js | endif
balt src/lib/graphql/mutations/user-sign-out.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 5resize ' . ((&columns * 89 + 135) / 270)
tabnext
edit src/lib/graphql/mutations/user-sign-in.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
balt src/lib/graphql/mutations/user-sign-in.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 99 - ((63 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 99
...
tabnext 1
set stal=1
badd +99 src/routes/_all-locales/user-sign-in/+page.svelte
badd +1 src/lib/graphql/mutations/user-sign-in.js
badd +1 src/routes/_all-locales/user-sign-out/+page.svelte
badd +2 src/lib/graphql/mutations/user-sign-out.js
