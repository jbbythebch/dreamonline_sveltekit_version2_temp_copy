...
wincmd w
argglobal
if bufexists("src/routes/_all-locales/entry-create/+page.svelte") | buffer src/routes/_all-locales/entry-create/+page.svelte | else | edit src/routes/_all-locales/entry-create/+page.svelte | endif
...
exe 'vert 3resize ' . ((&columns * 89 + 135) / 270)
tabnext
edit src/routes/_all-locales/user-register/+page.svelte
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
set winwidth=1
argglobal
balt src/routes/_all-locales/user-register/+page.svelte
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
tabnext 1
set stal=1
badd +18 src/routes/_all-locales/entry-create/+page.svelte
badd +1 src/routes/_all-locales/user-sign-in/+page.svelte
badd +0 src/lib/stores.js
badd +0 src/routes/_all-locales/user-register/+page.svelte
