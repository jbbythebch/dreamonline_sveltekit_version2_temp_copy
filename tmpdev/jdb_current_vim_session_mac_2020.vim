...
wincmd w
argglobal
if bufexists("src/routes/_all-locales/user-register/+page.svelte") | buffer src/routes/_all-locales/user-register/+page.svelte | else | edit src/routes/_all-locales/user-register/+page.svelte | endif
...
wincmd w
argglobal
if bufexists("src/lib/graphql/mutations/user-register.js") | buffer src/lib/graphql/mutations/user-register.js | else | edit src/lib/graphql/mutations/user-register.js | endif
balt src/routes/_all-locales/user-sign-in/+page.svelte
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
balt src/lib/graphql/mutations/user-register.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 4resize ' . ((&columns * 89 + 135) / 270)
tabnext
edit src/routes/_all-locales/user-sign-out/+page.svelte
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
wincmd w
argglobal
if bufexists("src/lib/users/user-email.svelte") | buffer src/lib/users/user-email.svelte | else | edit src/lib/users/user-email.svelte | endif
balt src/routes/_all-locales/user-sign-out/+page.svelte
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
balt src/lib/users/user-email.svelte
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
badd +5 src/routes/_all-locales/user-sign-out/+page.svelte
badd +1 src/lib/auth/page-protection.js
badd +1 src/routes/_all-locales/user-register/+page.svelte
badd +1 src/lib/graphql/mutations/user-register.js
badd +6 src/lib/stores.js
badd +6 src/lib/users/user-email.svelte
